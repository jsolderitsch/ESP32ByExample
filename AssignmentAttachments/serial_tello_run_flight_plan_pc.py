...
while not SETUP:
    try:
        ...
        # port = serial.Serial("/dev/cu.usbserial-022AF008", 115200, timeout=15)
...
process_tello_command("motoroff", 1)
process_tello_command("battery?", 1)
process_tello_command("takeoff", 1)
"""
...
"""
process_tello_command("rc 0 0 0 0", 1)
process_tello_command("rc 0 50 0 -100", 4)
process_tello_command("rc 0 0 0 0", 1)

process_tello_command("land", 1)
process_tello_command("battery?", 1)
# process_tello_command("command")
